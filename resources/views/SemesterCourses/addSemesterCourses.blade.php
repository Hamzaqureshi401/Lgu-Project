...
@section('content')
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-6">
                    ...
                    <select class="form-control custom-select border border-1 rounded border-dark" name="Sem_ID">
                ...
                <div class="form-group col-6">
                    ...
                    <input type="number" name="CampusLimit" class="form-control border border-1 rounded border-dark">
                </div>
    ...
    @endforeach
            ...
            <div class="form-group">
                <label>Course</label>
                <select class="form-control custom-select border border-1 rounded border-dark" name="Course_ID">

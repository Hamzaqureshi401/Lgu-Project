         ...
         <td colspan="3">
            <table style="width: 100%;">
               ...
               <tr>
                  ...
                  <td width="20%" style="text-align:right; border:1px solid #000;">{{ $challan->Tuition_Fee ?? '--' }}</td>
               </tr>
               <tr>
                  ...
                  <td width="20%" style="text-align:right; border:1px solid #000;">{{ $challan->Magazine_Fee ?? '--' }}</td>
               </tr>
               <tr>
                  ...
                  <td width="20%" style="text-align:right; border:1px solid #000;">{{ $challan->Exam_Fee ?? '--' }}</td>
               </tr>
               <tr>
                  ...
                  <td width="20%" style="text-align:right; border:1px solid #000;">{{ $challan->Society_Fee ?? '--' }}</td>
               </tr>
               <tr>
                  ...
                  <td width="20%" style="text-align:right; border:1px solid #000;">{{ $challan->Misc_Fee ?? '--' }}</td>
               </tr>
               <tr>
                  ...
                  <td width="20%" style="text-align:right; border:1px solid #000;">{{ $challan->Registration_Fee ?? '--' }}</td>
               </tr>
               <tr>
                  ...
                  <td width="20%" style="text-align:right; border:1px solid #000;">{{ $challan->Practical_charges ?? '--' }}</td>
               </tr>
               <tr>
                  ...
                  <td width="20%" style="text-align:right; border:1px solid #000;">{{ $challan->Sports_Fund ?? '--' }}</td>
               </tr>
               <tr>
                  ...
                  <td width="20%" style="text-align:right; border:1px solid #000;">{{ 0 }}</td>
               </tr>
               <tr>

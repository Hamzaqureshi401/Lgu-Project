        ...
        <tr>
            <td>
                <div class="row" style="font-size:10px;">
                    ...
                    <div class="col-6 text-right font-weight-bold"><span
                            style="font-size:12px; border-style : solid;">Grand Total:

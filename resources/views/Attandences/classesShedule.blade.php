                          ...
                          <td >
                            ...
                            <p class="badge badge-info badge-shadow" style="color:white;">{{ $day }}</p>
                             <p class="badge badge-success badge-shadow"style="color:white;">
                              {{ \Carbon\Carbon::parse( $timeTable->StartTime)->format('g:i a')}}</p>
                            <p class="badge badge-danger badge-shadow" style="color:white;">{{ \Carbon\Carbon::parse( $timeTable->EndTime)->format('g:i a')}}</p></td>
                            </a>
                          <td>aa</td>
                          <td>aa</td>
                          <td>aa</td>

<table class="borderof1px">
    <tr>
        {{-- <td style="width: 200px;"><img src="{{ public_path('assets/img/lgu_logo.jpg') }}"
...
<table class="borderof1px">
    ...
    <tr>
        <td colspan="4">Name of School/College/Campus Where employed:____________________</td>
...
<table style="margin-top: 10px;">
    <tr style="text-align: left">
        <td>________________________________________________________________________________________
        </td>
    </tr>
    <tr>

...
Route::post('/storeDegreeSemCoursesDetails', [App\Http\Controllers\DegreeSemCoursesController::class, 'addDegreeSemCoursesdetails'])->name('store.DegreeSemCoursesDetails');

...
Route::group(['middleware' => 'GetStdAdmission'], function () {
    ...
    Route::get('/logoutgettudentAdmission', [App\Http\Controllers\AdmissionController::class, 'logoutgetStudentAdmission'])->name('logout.getStudentAdmission');
});
...
Route::group(['middleware' => 'EmpAuth'], function () {
    ...
    Route::get('/deanStdIgrade', [App\Http\Controllers\IgradesController::class, 'deanStdIgrade'])->name('dean.Std.Igrade');
    Route::get('/confirmIgradesDean/{id?}', [App\Http\Controllers\IgradesController::class, 'confirmIgradesDean'])->name('confirm.Igrades.Dean');
